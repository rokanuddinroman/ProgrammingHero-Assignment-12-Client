    ...
    <div className="mx-auto max-w-7xl pb-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="my-auto px-[0.9rem] lg:px-0">
          ...
          <p>
            Subscribe to get special offers, free giveaways, and product launch
            information. Get $10 off on your first order after subscribing.
          </p>
          <div className="mt-3">
            <input
              className="w-[100%] rounded-[8px] bg-[#f6fbfe] p-[10px] mb-3 border-[2px] border-[#e3e8eb] lg:w-[70%]"
              type="text"
            />
            <br />
