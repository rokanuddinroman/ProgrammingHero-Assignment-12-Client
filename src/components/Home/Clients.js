    ...
    <div className="py-8 bg-[#F5F5F5]">
      <div className="mx-auto max-w-7xl text-center px-[0.9rem] lg:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 mt-10 mb-6 mx-auto max-w-6xl">
          <img
            className="w-[150px] mb-4 mx-auto bw-img"
            src="https://logos-download.com/wp-content/uploads/2019/06/Fiskars_Logo.png"
            alt=""
          />
          <img
            className="w-[150px] mb-4 mx-auto bw-img"
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Ames_Stores_Logo_Red.svg/1280px-Ames_Stores_Logo_Red.svg.png"
            alt=""
          />
          <img
            className="w-[150px] mb-4 mx-auto bw-img"
            src="https://images.squarespace-cdn.com/content/v1/56b354e9b09f950655e35066/1458745520904-OFZHIY4GAOMC1R5M9DYB/image-asset.png?format=1000w"
            alt=""
          />
          <img
            className="w-[150px] mb-4 mx-auto bw-img"
