    ...
    return (
        <div className='bg-primary text-white fixed w-[100%] top-0 z-50'>
            <div className="max-w-7xl mx-auto flex justify-between items-center px-[0.9rem] lg:px-0">
                            ...
                            user ?
                                <div class="dropdown dropdown-end">
                                    ...
                                    <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 drop-shadow-lg rounded-box w-[400px]">
                                        <li>
                                            <div onClick={() => { navigate('/dashboard/myprofile') }} className='cursor-pointer flex items-center mb-[4px] rounded-[8px] hover:bg-[#f2fbff]'>
                                                <img className='rounded-[10px] object-cover w-[60px] h-[60px]' src={user.photoURL} alt="" />
                                                <div className="ml-2">
                                                    <h1 className="font-[500] text-[18px] text-gray-600">{user.displayName}</h1>
                                        ...
                                        <li>
                                            <div className='text-gray-600 active:bg-slate-600 ' onClick={() => logout()}>Sign Out</div>
                                        </li>
                                    </ul>
                                </div>
                                :
                ...
                <button className='show-button' onClick={() => setShow(!show)}><ImMenu3 color="white" className="text-[30px]" /></button>
            </div>
        </div>
    );
};
