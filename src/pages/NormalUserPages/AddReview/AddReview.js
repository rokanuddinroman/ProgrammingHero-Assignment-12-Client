            ...
            <form onSubmit={handleAddReview} >
                <div className='grid grid-cols-2 gap-4 mt-4'>
                    <div>
                        ...
                        <input className='w-[100%] rounded-[8px] bg-[#f6fbfe] p-[10px] mb-3 border-[2px] border-[#e3e8eb]' type="number" name="rating" id="rating" max="5" maxLength="5" required />
                    </div>
                    <div>
                        <label htmlFor="review">Review</label>
                        <textarea className='w-[100%] rounded-[8px] bg-[#f6fbfe] p-[10px] mb-3 h-[136px] border-[2px] border-[#e3e8eb]' type="text" name="review" id="review" cols="20" rows="10" required></textarea>
                    </div>
                </div>
