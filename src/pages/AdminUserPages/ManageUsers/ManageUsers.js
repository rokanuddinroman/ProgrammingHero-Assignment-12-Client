    ...
    return (
        <div>
            ...
            <div className='product-rows mt-2'>
                ...
                {
                    users.map(user => <TableRow setShowModal={setShowModal} showModal={showModal} key={user._id} user={user} handleDelete={handleDelete}></TableRow>)
                }
            </div>
                ...
                <div class="modal modal-bottom sm:modal-middle">
                    <div class="modal-box">
                        ...
                        <div class="modal-action">
                            ...
                            <label onClick={() => handleDelete(showModal.email)} for="confirmModal" class="btn bg-red-500">Delete</label>
                        </div>
                    </div>
                </div>
            </div>
